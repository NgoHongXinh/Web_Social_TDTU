                    ...
                    <div className="card post-card h-100">
                            <div className="media">
                                ...
                                <div className="media-body">
                                    ...
                                    {/*nút bình luận*/}
                                    <a onClick={getComments} postcode = "18b5863c-5390-4e26-9e32-2b37fd58b7f8" className="btn btn-sm btn-danger mt-1 m-1"><svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="currentColor" className="bi bi-chat-dots bi-sm" viewBox="0 0 16 16">
